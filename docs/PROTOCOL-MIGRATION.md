...
the fixture coverage that follows each service as it gains a canon, and the
**SFU**, which is the one thing screenshare's signalling still answers for
without: there is no media server in this tree, so the SDP answer is empty and
