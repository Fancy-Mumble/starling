...
they have no canon (screenshare, link-preview), and the fixture coverage that
follows each one as it gains a canon. **userdata came off that list**: its
envelope is decoded now, see M2b.
